    ...
    private class ProjectsDatabaseCallback : RoomDatabase.Callback() {
        ...
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            INSTANCE!!.projectsDao().insert(
                ...
                .concatWith(INSTANCE!!.taskFirstDao().insert(TaskFirstLevel(2, "Task 1/1", System.currentTimeMillis(), 0, 0)))
                .concatWith(INSTANCE!!.taskFirstDao().insert(TaskFirstLevel(2, "Task 1/2", System.currentTimeMillis(), 0, 0)))
                .concatWith(INSTANCE!!.taskFirstDao().insert(TaskFirstLevel(2, "Task 1/3", System.currentTimeMillis(), 0, 0)))
                .concatWith(INSTANCE!!.taskSecondDao().insert(TaskSecondLevel(1, "TASK 2/1", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskSecondDao().insert(TaskSecondLevel(1, "TASK 2/2", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskSecondDao().insert(TaskSecondLevel(1, "TASK 2/3", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskSecondDao().insert(TaskSecondLevel(2, "TASK 2/4", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskSecondDao().insert(TaskSecondLevel(2, "TASK 2/5", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskThirdDao().insert(TaskThirdLevel(1, "TSK 3/1", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskThirdDao().insert(TaskThirdLevel(2, "TSK 3/2", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskThirdDao().insert(TaskThirdLevel(2, "TSK 3/3", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskThirdDao().insert(TaskThirdLevel(3, "TSK 3/4", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskThirdDao().insert(TaskThirdLevel(4, "TSK 3/5", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskThirdDao().insert(TaskThirdLevel(4, "TSK 3/6", 0, 0, 0)))
                .concatWith(INSTANCE!!.taskThirdDao().insert(TaskThirdLevel(4, "TSK 3/7", 0, 0, 0)))
